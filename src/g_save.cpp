...
SAVE_STRUCT_START
	...
	FIELD_AUTO(zaero_transient_lastweapon),
	FIELD_AUTO(zaero_flare_flash_ticks),
	FIELD_AUTO(zaero_flare_flash_base),
	FIELD_AUTO(zaero_sonic_charge_start),
...
SAVE_STRUCT_START
	...
	FIELD_LEVEL_STRING(model2),
	FIELD_LEVEL_STRING(model3),
	FIELD_LEVEL_STRING(model4),
	FIELD_AUTO(freetime),
	...
	FIELD_AUTO(decel),
	FIELD_AUTO(aspeed),
	FIELD_AUTO(zaero_rotating_state),
	FIELD_AUTO(movedir),
	FIELD_AUTO(pos1),
	FIELD_AUTO(pos2),
	FIELD_AUTO(pos3),
