...
enum ammo_t : uint8_t
{
	...
	AMMO_PROX,
	// ROGUE
	// ZAERO. Appended to preserve every upstream protocol-facing ammo ID.
	AMMO_FLARES,
	AMMO_IRED,
	AMMO_EMPNUKE,
	AMMO_A2K,
...
enum player_stat_t
{
	...
	// ZAERO used legacy stats 16-21, which now collide with CTF/Rerelease.
	// Keep six explicitly named, contiguous private slots at the end instead.
