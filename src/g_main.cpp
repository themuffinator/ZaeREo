...
void InitGame()
{
	...
	InitSave();
	Zaero_SetIREDEMPCheck(Zaero_EMPNukeCheck);
	Zaero_SetSonicEMPCheck(Zaero_EMPNukeCheck);
	...
	// Zaero bit 0 disables flare compensation damage; bit 1 enables Zaero
	// item injection in deathmatch. Keep the historic server-info name.
