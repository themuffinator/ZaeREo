...
*/
constexpr spawnflags_t SPAWNFLAG_TARGET_EXPLOSION_ZAERO_A2K_STYLE = 1_spawnflag;
...
THINK(target_explosion_explode) (edict_t *self) -> void
{
	if (level.zaero_mapper_contract && self->spawnflags.has(SPAWNFLAG_TARGET_EXPLOSION_ZAERO_A2K_STYLE))
	{
		...
		// below deliberately remain identical.
		gi.positioned_sound(self->s.origin, self, CHAN_AUTO,
			gi.soundindex("weapons/a2k/ak_exp01.wav"), 1, ATTN_NORM, 0);
