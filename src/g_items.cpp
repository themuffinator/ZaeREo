...
// every native/mission-pack entry plus the Zaero registry below. Push and
...
bool Pickup_Pack(edict_t *ent, edict_t *other)
{
	...
	// ZAERO deliberately omits Flares from both the Pack cap increase and the
	// Pack grant. Preserve that non-obvious inventory contract.
	G_AdjustAmmoCap(other, AMMO_IRED, 100);
	G_AdjustAmmoCap(other, AMMO_A2K, 1);
	G_AdjustAmmoCap(other, AMMO_EMPNUKE, 100);
	G_AdjustAmmoCap(other, AMMO_PLASMASHIELD, 40);
	...
	G_AddAmmoAndCapQuantity(other, AMMO_IRED);
	G_AddAmmoAndCapQuantity(other, AMMO_A2K);
	G_AddAmmoAndCapQuantity(other, AMMO_EMPNUKE);
	G_AddAmmoAndCapQuantity(other, AMMO_PLASMASHIELD);
...
{
	if (item->flags & IF_NO_WEAPON_SELECTION)
		return;
	...
	// switch!
	if ((item->flags & (IF_TRANSIENT_WEAPON | IF_PENDING_IMPLEMENTATION)) &&
		item != ent->client->pers.weapon)
		ent->client->zaero_transient_lastweapon = ent->client->pers.lastweapon;
	ent->client->newweapon = item;
}
...
bool Pickup_Ammo(edict_t *ent, edict_t *other)
{
	...
	if (level.zaero_mapper_contract && ent->spawnflags.has(SPAWNFLAG_ITEM_MAX))
	{
		...
		// 0x08 makes ent->count the final inventory ceiling for this pickup,
		// rather than an amount to add to the existing stack.
		count -= oldcount;
	}
...
void Drop_Ammo(edict_t *ent, gitem_t *item)
{
	...
	const bool empties_active_ammo_weapon =
		ent->client->pers.weapon == item && (item->flags & IF_AMMO) &&
	...
	// Do not leave a zero-count throwable selected.  Queue the native fallback
	// so an in-flight throw can finish through the ordinary weapon state machine
	// before the replacement is raised.
	if (empties_active_ammo_weapon)
...
void SpawnItem(edict_t *ent, gitem_t *item)
{
	...
	else if (ent->spawnflags.value >= SPAWNFLAG_ITEM_MAX.value && !valid_zaero_ammo_spawnflags) // PGM
	{
...
/* Regeneration Tech */
	...
	// ---------------------------------------------------------------------
	// ZAERO item ABI. Keep this order synchronized with the appended IDs in
	// g_local.h; exact classnames and case-sensitive runtime paths are mapper
	// and savegame compatibility interfaces.

	{
		/* id */ IT_WEAPON_PUSH,
		/* classname */ "weapon_push",
		/* pickup */ nullptr,
		/* use */ Use_Weapon,
		/* drop */ nullptr,
		/* weaponthink */ Weapon_ZaeroPush,
		/* pickup_sound */ nullptr,
		/* world_model */ nullptr,
		/* world_model_flags */ EF_NONE,
		/* view_model */ "models/weapons/v_hand/tris.md2",
		/* icon */ nullptr,
		/* use_name */ "Push",
		/* pickup_name */ "Push",
		/* pickup_name_definite */ "Push",
		/* quantity */ 0,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_WEAPON | IF_STAY_COOP | IF_NOT_GIVEABLE | IF_NOT_RANDOM |
			IF_NO_INVENTORY | IF_NO_WEAPON_SELECTION | IF_TRANSIENT_WEAPON,
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ 0,
		/* precaches */ "weapons/push/contact.wav"
	},

	{
		/* id */ IT_WEAPON_FLAREGUN,
		/* classname */ "weapon_flaregun",
		/* pickup */ Pickup_Weapon,
		/* use */ Use_Weapon,
		/* drop */ Drop_Weapon,
		/* weaponthink */ Weapon_ZaeroFlareGun,
		/* pickup_sound */ "misc/w_pkup.wav",
		/* world_model */ "models/weapons/g_flare/tris.md2",
		/* world_model_flags */ EF_ROTATE | EF_BOB,
		/* view_model */ "models/weapons/v_flare/tris.md2",
		/* icon */ "w_flare",
		/* use_name */ "Flare Gun",
		/* pickup_name */ "Flare Gun",
		/* pickup_name_definite */ "the Flare Gun",
		/* quantity */ 1,
		/* ammo */ IT_AMMO_FLARES,
		/* chain */ IT_WEAPON_FLAREGUN,
		/* flags */ IF_WEAPON | IF_STAY_COOP,
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ 0,
		/* precaches */ "models/objects/flare/tris.md2 weapons/flare/shoot.wav weapons/flare/flarehis.wav weapons/flare/ignite.wav weapons/flare/out.wav",
		/* sort_id */ 0,
		/* quantity_warn */ 3
	},

	{
		...
		/* use */ Use_Weapon,
		/* drop */ Drop_Ammo,
		/* weaponthink */ Weapon_ZaeroIRED,
		/* pickup_sound */ "misc/am_pkup.wav",
		/* world_model */ "models/items/ammo/ireds/tris.md2",
		/* world_model_flags */ EF_NONE,
		/* view_model */ "models/weapons/v_ired/tris.md2",
		/* icon */ "w_ired",
		/* use_name */ "IRED",
		/* pickup_name */ "IRED",
		/* pickup_name_definite */ "an IRED",
		/* quantity */ 3,
		/* ammo */ IT_AMMO_IRED,
		/* chain */ IT_AMMO_IRED,
		/* flags */ IF_AMMO | IF_WEAPON,
		...
		/* armor_info */ nullptr,
		/* tag */ AMMO_IRED,
		/* precaches */ "models/weapons/v_ired/hand.md2 models/objects/ired/tris.md2 models/objects/shrapnel/tris.md2 weapons/ired/las_set.wav weapons/ired/las_arm.wav weapons/ired/las_tink.wav weapons/ired/las_trig.wav weapons/ired/las_glow.wav weapons/ired/las_exp.wav",
		/* sort_id */ 0,
		/* quantity_warn */ 3
	},

	{
		...
		/* use */ Use_Weapon,
		/* drop */ Drop_Weapon,
		/* weaponthink */ Weapon_ZaeroSniperRifle,
		/* pickup_sound */ "misc/w_pkup.wav",
		...
		/* pickup_name_definite */ "the Sniper Rifle",
		/* quantity */ 3,
		/* ammo */ IT_AMMO_SLUGS,
		/* chain */ IT_WEAPON_SNIPERRIFLE,
		/* flags */ IF_WEAPON | IF_STAY_COOP | IF_NO_WEAPON_SELECTION,
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ 0,
		/* precaches */ "models/weapons/v_sniper/scope/tris.md2 models/weapons/v_sniper/dmscope/tris.md2 weapons/sniper/beep.wav weapons/sniper/fire.wav weapons/sniper/snip_act.wav weapons/sniper/snip_bye.wav",
		/* sort_id */ 0,
		/* quantity_warn */ 6
	},

	{
		/* id */ IT_WEAPON_SONICCANNON,
		/* classname */ "weapon_soniccannon",
		/* pickup */ Pickup_Weapon,
		/* use */ Use_Weapon,
		/* drop */ Drop_Weapon,
		/* weaponthink */ Weapon_ZaeroSonicCannon,
		/* pickup_sound */ "misc/w_pkup.wav",
		/* world_model */ "models/weapons/g_sonic/tris.md2",
		/* world_model_flags */ EF_ROTATE | EF_BOB,
		/* view_model */ "models/weapons/v_sonic/tris.md2",
		/* icon */ "w_sonic",
		/* use_name */ "Sonic Cannon",
		/* pickup_name */ "Sonic Cannon",
		/* pickup_name_definite */ "the Sonic Cannon",
		/* quantity */ 1,
		/* ammo */ IT_AMMO_CELLS,
		/* chain */ IT_WEAPON_SONICCANNON,
		/* flags */ IF_WEAPON | IF_STAY_COOP,
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ 0,
		/* precaches */ "weapons/sonic/sc_warm.wav weapons/sonic/sc_cool.wav weapons/sonic/sc_fire.wav weapons/sonic/sc_act.wav weapons/sonic/sc_dact.wav weapons/sonic/sc_idle.wav",
		/* sort_id */ 0,
		/* quantity_warn */ 30
	},

	{
		...
		/* world_model_flags */ EF_NONE,
		/* view_model */ "models/weapons/v_a2k/tris.md2",
		/* icon */ "w_a2k",
		/* use_name */ "A2K",
		/* pickup_name */ "A2K",
		/* pickup_name_definite */ "the A2K",
		/* quantity */ 1,
		/* ammo */ IT_AMMO_A2K,
		/* chain */ IT_AMMO_A2K,
...

	{
		...
		/* weaponthink */ nullptr,
		/* pickup_sound */ "misc/am_pkup.wav",
		/* world_model */ "models/items/ammo/flares/tris.md2",
		/* world_model_flags */ EF_NONE,
		/* view_model */ nullptr,
		/* icon */ "a_flares",
		/* use_name */ "Flares",
		/* pickup_name */ "Flares",
		/* pickup_name_definite */ "the Flares",
		/* quantity */ 3,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_AMMO,
...

	{
		...
		/* use */ Use_Weapon,
		/* drop */ Drop_Ammo,
		/* weaponthink */ Weapon_ZaeroEMPNuke,
		/* pickup_sound */ "misc/am_pkup.wav",
		/* world_model */ "models/weapons/g_enuke/tris.md2",
		/* world_model_flags */ EF_ROTATE | EF_BOB,
		/* view_model */ "models/weapons/v_enuke/tris.md2",
		/* icon */ "w_enuke",
		/* use_name */ "EMPNuke",
		/* pickup_name */ "EMPNuke",
		/* pickup_name_definite */ "the EMPNuke",
		/* quantity */ 1,
		/* ammo */ IT_AMMO_EMPNUKE,
		/* chain */ IT_AMMO_EMPNUKE,
		/* flags */ IF_AMMO | IF_NO_INFINITE_AMMO,
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ AMMO_EMPNUKE,
		/* precaches */ "items/empnuke/emp_trg.wav items/empnuke/emp_act.wav items/empnuke/emp_spin.wav items/empnuke/emp_idle.wav items/empnuke/emp_missfire.wav items/empnuke/empactive.wav",
		/* sort_id */ 0,
		/* quantity_warn */ 1
	},

	{
		...
		/* use_name */ "Visor",
		/* pickup_name */ "Visor",
		/* pickup_name_definite */ "the Visor",
		/* quantity */ 30,
		/* ammo */ IT_AMMO_CELLS,
		/* chain */ IT_NULL,
		/* flags */ IF_STAY_COOP | IF_POWERUP | IF_POWERUP_WHEEL,
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ POWERUP_ZAERO_VISOR,
		/* precaches */ "items/visor/act.wav items/visor/deact.wav items/visor/next.wav"
	},

	{
		...
		/* pickup_name */ "Plasma Shield",
		/* pickup_name_definite */ "the Plasma Shield",
		/* quantity */ 5,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_AMMO | IF_POWERUP_WHEEL,
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ AMMO_PLASMASHIELD,
		/* precaches */ "items/plasmashield/psfire.wav items/plasmashield/psactive.wav items/plasmashield/psdie.wav sprites/plasmashield.sp2",
		/* sort_id */ 0,
		/* quantity_warn */ 5
	},

	{
		/* id */ IT_KEY_LANDING_AREA,
		...
		/* pickup_name */ "Airfield Pass",
		/* pickup_name_definite */ "the Airfield Pass",
		/* quantity */ 0,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_STAY_COOP | IF_KEY
...

	{
		...
		/* pickup_name */ "Laboratory Key",
		/* pickup_name_definite */ "the Laboratory Key",
		/* quantity */ 0,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_STAY_COOP | IF_KEY
...

	{
		...
		/* pickup_name */ "Clearance Pass",
		/* pickup_name_definite */ "the Clearance Pass",
		/* quantity */ 0,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_STAY_COOP | IF_KEY
...

	{
		...
		/* pickup_name_definite */ "the Energy Key",
		/* quantity */ 0,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_STAY_COOP | IF_KEY
...

	{
		...
		/* pickup_name_definite */ "the Lava Key",
		/* quantity */ 0,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_STAY_COOP | IF_KEY
...

	{
		...
		/* pickup_name_definite */ "the Slime Key",
		/* quantity */ 0,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_STAY_COOP | IF_KEY
...
static_assert(q_countof(itemlist) == IT_TOTAL, "itemlist and item_id_t must remain one-to-one");
...
void SetItemNames()
{
	...
	for (item_id_t i = IT_NULL; i < IT_TOTAL; i = static_cast<item_id_t>(i + 1))
	{
		if (!(itemlist[i].flags & IF_WEAPON) || (itemlist[i].flags & IF_NO_WEAPON_SELECTION))
			continue;
